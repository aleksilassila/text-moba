...
parser.add_argument('-b', '--bullets', type = int, help = 'Set max bullets in air per player, 0 to disable bullets')
parser.add_argument('-r', '--rockets', type = int, help = 'Set max rockets in air per player, 0 to disable rockets')
parser.add_argument('--tickrate', type = int, help = 'How many times game state will be updated per second')
...
game.tickrate = 10 if args.tickrate == None else args.tickrate
